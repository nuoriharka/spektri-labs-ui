  ...
  return (
    ...
    >
      <div className="relative pt-24 md:pt-36">
        {heroError ? (
          <div className="rounded-xl bg-destructive/10 p-6 text-destructive text-center">
            <strong>HeroScene ei voitu ladata.</strong>
            <div className="mt-2 text-xs">{heroError.message}</div>
          </div>
        ) : (
          <ErrorBoundary>
            <HeroScene />
