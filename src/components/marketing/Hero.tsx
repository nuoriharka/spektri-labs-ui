    ...
    <section className="relative overflow-hidden">
      ...
      <Container>
        <div className="py-28 md:py-36 max-w-2xl">
          ...
          <p className="mt-6 text-lg text-white/80">Käytä parasta työkalua kuhunkin vaiheeseen – Spektri sitoo ne yhteen.</p>
          <div className="mt-8 flex items-center gap-3">
            <PrimaryCta href="/dashboard" event="hero_cta_click">Aloita ilmaiseksi</PrimaryCta>
            <button
              onClick={() => {
                track('demo_opened');
